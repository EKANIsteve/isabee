...
<section class="documents-section reveal" id="documents-isabee">
    <div class="container">
        ...
        <div class="section-title">
            ...
            <p>
                Téléchargez les documents utiles : flyer du concours, livret de présentation
                et programme de Master International.
            </p>
        </div>
        ...
        <div class="documents-grid">
            ...
            <div class="document-card">
                ...
                <p>
                    Informations sur les filières, les places disponibles, les frais,
                    les épreuves, les centres et la composition du dossier.
                </p>
            ...
            <div class="document-card">
                ...
                <div class="download-actions">
                    @if(file_exists(public_path('documents/livret-isabee-2026-francais.pdf')))
                        <a href="{{ asset('documents/livret-isabee-2026-francais.pdf') }}"
                           class="download-btn"
                           download>
                            <i class="fa-solid fa-download"></i>
                            Français
